            ...
            <div class="col-xs-12 col-sm-8 col-md-8" id="content">
                <div class="content-inner">
                    ...
                    <div class="feature top-video">
                            <h1><b>Tag</b>: <?php echo $tags['Tag']['tag_name']; ?></h1>
                    </div>
                </div>
                <div class="content-inner">
                    ...
                    <div id="load-more-video" class="mm-load-more">
                        <div class="box-inner">
                            ...
                            <button class="btn-default btn mm-btn-load-more" type="button" page='2' tag_alias="<?php echo $tags['Tag']['tag_alias'] ?>" url="<?php echo DOMAIN.'Video/ajaxTagLoadMore' ?>">
