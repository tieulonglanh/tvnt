    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header">
                ...
                <div class="box-tools">
                    <?php echo $this->Form->create(null, array('url' => DOMAINAD . 'post/search', 'type' => 'post', 'name' => 'frm_search')); ?>
            ...
            <div class="box">
                <div class="box-body table-responsive no-padding">
                    ...
                    <?php echo $this->Form->create(null, array('url' => DOMAINAD . 'post/action_all', 'type' => 'post', 'name' => 'frm_list')); ?>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <?php foreach ($Post as $key => $value) {  ?>
                            <tr>
                                <td><input type="checkbox" name="chose_active[<?php echo $value['Post']['id']; ?>]" /></td>
                                ...
                                <td>
                                    <a href="<?php echo DOMAINAD ?>post/copy/<?php echo $value['Post']['id']; ?>" title="Copy"><img src="<?php echo DOMAINAD ?>images/icons/copy.png" alt="Copy" /></a>
                                    <a href="<?php echo DOMAINAD ?>post/edit/<?php echo $value['Post']['id']; ?>" title="Edit"><img src="<?php echo DOMAINAD ?>images/icons/pencil.png" alt="Edit" /></a> <a href="javascript:confirmDelete('<?php echo DOMAINAD ?>post/delete/<?php echo $value['Post']['id']; ?>')" title="Delete"><img src="<?php echo DOMAINAD ?>images/icons/cross.png" alt="Delete" /></a>
                                    <?php
                                    if ($value['Post']['status'] == 0) {
                                        ?>
                                        <a href="<?php echo DOMAINAD ?>post/active/<?php echo $value['Post']['id']; ?>" title="Kích hoạt" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD ?>images/icons/Play-icon.png" alt="Kích hoạt" /></a>
                                    <?php
                                    } else {
                                        ?>
                                        <a href="<?php echo DOMAINAD ?>post/close/<?php echo $value['Post']['id']; ?>" title="Đóng" class="icon-4 info-tooltip"><img src="<?php echo DOMAINAD ?>images/icons/success-icon.png" alt="Ngắt kích hoạt" /></a>
                                    <?php
                                    }
                                    ?></td>
