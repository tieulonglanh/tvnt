<?php echo $this->Form->create(null, array('url' => DOMAINAD . 'Role/add', 'type' => 'Role', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
<div id="khung">
    <div id="main">
        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Role.role_name', array('label' => '', 'class' => 'text-input medium-input', 'onchange' => 'get_alias()', 'id' => 'idtitle')); ?>
                    </td>
               	</tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if(!empty($list_controller)){ foreach($list_controller as $key => $value){ ?>
                                ...
                                <div class="phone_manu_box_right">
                                    <?php if(!empty($value)){foreach($value as $p_key => $p_value){?>
                                        <div class="phone_name" style="float: left; width: 190px;">
                                            <input type="checkbox" class="input_check_controller_<?php echo $key; ?>" id="input_checkbox_<?php echo $key; ?>_<?php echo $p_value;?>" name="action[<?php echo $key; ?>][<?php echo $p_value;?>]" style="float: left;" />
