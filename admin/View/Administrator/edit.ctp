...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> Sửa tài khoản quản trị</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <!-- form start -->
                <?php echo $this->Form->create(null, array('url' => DOMAINAD . 'administrator/edit', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
                ...
                <div class="box-body">
                    <?php if($this->Session->read('role_id') == 5): ?>
                    ...
                    <?php else: ?>
                        <label for="idtitle">Tên đăng nhập</label>
                        <?php echo $this->Form->input('Administrator.name', array('label' => '',  'disabled' => 'disabled', 'class' => 'form-control')); ?>
                    <?php endif; ?>
                    <br />
                    ...
                    <br />
                    <div class="form-group show_re_pass">
                    ...
                    <?php endif; ?>
                    <?php echo $this->Form->input('Administrator.id',array('type'=>'hidden')); ?>
